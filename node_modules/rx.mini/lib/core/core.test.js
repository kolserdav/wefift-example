...
describe("event", function () {
    ...
    test("aspromise", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var testEvent, res;
    ...
    test("complete", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    expect(function () { return event.subscribe(function () { }); }).toThrowError("event completed");
                    expect(function () { return event.execute(0); }).toThrowError("event completed");
                    return [2 /*return*/];
            }
        });
    }); });
    test("test-error", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var event, res, res;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
