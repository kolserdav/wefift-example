...
exports.createSelfSignedCertificate = exports.RtpBuilder = exports.parseIceServers = exports.compactNtp = exports.ntpTime = exports.milliTime = exports.microTime = exports.reverseDirection = exports.orDirection = exports.andDirection = exports.reverseSimulcastDirection = exports.isRtcp = exports.isMedia = exports.isDtls = exports.fingerprint = void 0;
...
const log = (0, debug_1.default)("werift/webrtc/utils");
...
class RtpBuilder {
    constructor() {
        this.sequenceNumber = (0, src_1.random16)();
        this.timestamp = (0, src_1.random32)();
    }
    create(payload) {
